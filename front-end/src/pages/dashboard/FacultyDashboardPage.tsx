        ...
        <div className="max-w-6xl mx-auto px-6 py-3 flex items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              ...
              <p className="text-[10px] text-slate-400 uppercase tracking-widest">Faculty &amp; Staff Dashboard</p>
            </div>
          </div>
          ...
          <Card className="lg:col-span-1">
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              <div className="flex items-center justify-between">
                ...
                <Badge className="text-[10px] bg-indigo-100 text-indigo-700">{user.role}</Badge>
              </div>
              {user.contactNumber && (
                <div className="flex items-center justify-between">
            ...
            <CardContent>
              <form className="space-y-3 text-sm" onSubmit={submitIncident}>
                ...
                <div className="flex items-center gap-3 rounded-md border border-slate-200 px-3 py-2">
                  <input
                    type="checkbox"
                    id="faculty-anonymous-toggle"
                    checked={incidentForm.anonymous ?? false}
                    onChange={(e) => setIncidentForm((prev) => ({ ...prev, anonymous: e.target.checked }))}
                    className="h-4 w-4 rounded border-slate-300 text-violet-600 focus:ring-violet-500"
                  />
                  <label htmlFor="faculty-anonymous-toggle" className="text-slate-700 text-sm cursor-pointer select-none">
                    Report anonymously
                  </label>
